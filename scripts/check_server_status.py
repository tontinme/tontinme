...
#in crontab
#Usage: 15 */1 * * * /usr/bin/python /home/supertool/tian/check_server_status.py -a 192.168.1.198 -p 22 >> /home/supertool/tian/check_server_status.log 2>&1
...
#---------------------------------------------------------------
# Name:        check_server_status.py
# Purpose:     check 198 status
# Author:      tianshuang
# Email:       tianshuang@supertool.net.cn
# Created:     2011/06/10
# Copyright:   (c) 2011
#--------------------------------------------------------------
...
to_addr = 'tianshuang@supertool.net.cn'
smtp_user = 'check_server'
smtp_pass = 'check_supertool'
